        ...
        <div className="flex items-center gap-2 sm:gap-4 min-w-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-[14px] sm:text-[22px] font-extrabold m-0 leading-none whitespace-nowrap" style={{fontFamily:mono,background:`linear-gradient(135deg,${t.accent},${t.blue})`,backgroundClip:"text",WebkitBackgroundClip:"text",color:"transparent",WebkitTextFillColor:"transparent"}}>PARALAN.TRADE</h1>
